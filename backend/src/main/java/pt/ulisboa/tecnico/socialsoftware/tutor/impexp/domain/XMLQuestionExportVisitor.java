...
public class XMLQuestionExportVisitor implements Visitor {
    ...
    public void visitQuestionDetails(MultipleChoiceQuestion question) {
        ...
        Element isOrderedElement = new Element("isOrdered");
        this.currentElement.addContent(isOrderedElement);
    ...
    public void visitQuestionDetails(OpenAnswerQuestion question) {
        ...
        if (question.isRegex()) regexElement.addContent("regex on");
        else regexElement.addContent("regex off");
