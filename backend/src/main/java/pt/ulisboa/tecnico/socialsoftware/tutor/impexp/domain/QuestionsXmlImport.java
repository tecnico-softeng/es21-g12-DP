...
public class QuestionsXmlImport {
    ...
    private QuestionDetailsDto importMultipleChoiceQuestion(Element questionElement) {
        ...
        boolean bol = Boolean.parseBoolean(questionElement.getAttributeValue("isOrdered"));
        for (Element optionElement : questionElement.getChild("options").getChildren("option")) {
            ...
            Integer order = Integer.valueOf(optionElement.getAttributeValue("order"));
        ...
        multipleChoiceQuestionDto.setOrdered(bol);
    ...
    private QuestionDetailsDto importOpenAnswerQuestion(Element questionElement) {
        ...
        boolean regex= Boolean.parseBoolean(questionElement.getAttributeValue("regex"));
        questionDto.setRegex(regex);
        return questionDto;
    }
