...
class ImportExportOpenAnswerQuestionsTest extends SpockTest {
    ...
    def setup() {
        ...
        openAnswerQuestionDto.setRegex(false)
    ...
    def 'export and import questions to xml'() {
        ...
        def openAnswerQuestionDto = (OpenAnswerQuestionDto) questionResult.getQuestionDetailsDto()
        openAnswerQuestionDto.getAnswer() == ANSWER_1_CONTENT
        !openAnswerQuestionDto.isRegex()
    }
