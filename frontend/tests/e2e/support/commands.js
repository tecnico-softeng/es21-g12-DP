...
Cypress.Commands.add(
  ...
  (title, question, answer, regex) => {
    cy.get('[data-cy="managementMenuButton"]').click();
    cy.get('[data-cy="questionsTeacherMenuButton"]').click();

    //creates open answer question
    cy.get('[data-cy="newQuestionButton"]').click();
    cy.get('[data-cy="questionTitleTextArea"]').type(title);
    cy.get('[data-cy="questionQuestionTextArea"]').type(question);
    cy.get('[data-cy="questionAnswerTextArea"]').type(answer);
    cy.get('[data-cy="regexSwitch"]').click({ force: regex });
    cy.get('[data-cy="saveQuestionButton"]').click();
    cy.wait(1000);
  }
);
...
Cypress.Commands.add(
  'viewOpenAnswerQuestionButton', questionTitle => {
    cy.get('[data-cy="managementMenuButton"]').click();
    cy.get('[data-cy="questionsTeacherMenuButton"]').click();
    cy.contains(questionTitle)
      .parent()
      ...
      .children()
      .should('have.length', 10)
      .find('[data-cy="viewQuestionButton"]')
      .click();
  }
);

Cypress.Commands.add(
  'viewOpenAnswerQuestionClick', questionTitle => {
    cy.get('[data-cy="managementMenuButton"]').click();
    cy.get('[data-cy="questionsTeacherMenuButton"]').click();
...
Cypress.Commands.add(
  ...
  (questionTitle, new_content) => {
    ...
    cy.contains(questionTitle)
      ...
      .click();
    cy.get('[data-cy="questionQuestionTextArea"]').clear();
    cy.get('[data-cy="questionQuestionTextArea"]').type(new_content);
    cy.get('[data-cy="saveQuestionButton"]').click();
    cy.wait(1000);
  }
);
...
Cypress.Commands.add(
  ...
  (questionTitle, newTitle) => {
    ...
    cy.get('[data-cy="questionTitleTextArea"]').clear();
    cy.get('[data-cy="questionTitleTextArea"]').type(newTitle);
    cy.get('[data-cy="saveQuestionButton"]').click();
    cy.wait(1000);
  }
);
...
Cypress.Commands.add(
  ...
  (questionTitle, new_content) => {
    ...
    cy.contains(questionTitle)
      ...
      .children()
      .should('have.length', 10)
      .find('[data-cy="duplicateQuestionButton"]')
      .click();
    cy.wait(1000);
    cy.get('[data-cy="saveQuestionButton"]').click();
    cy.wait(1000);
