describe('Manage Multiple Choice Questions Walk-through', () => {
  ...
  function validateQuestionMultipleRightAnswers(
    title,
    content,
    optionPrefix = 'Option ',
    correctIndex1 = 2,
  ...
  function validateQuestionFullMultipleRightAnswers(
    title,
    content,
    optionPrefix = 'Option ',
    correctIndex1 = 2, 
    ...
    validateQuestionMultipleRightAnswers(title, content, optionPrefix, correctIndex1, correctIndex2);
  ...
  it('Creates a new multiple choice question with two correct answers', function() {
    cy.get('button')
    ...
    validateQuestionFullMultipleRightAnswers(
      'Cypress Question Example - 01',
      'Cypress Question Example - Content - 01'
    );
  });

  it('Can delete created question with two right answers', function() {
  ...
  it('Can view question (with button)', function() {
    ...
    validateQuestionMultipleRightAnswers(
      'Cypress Question Example - 01',
      'Cypress Question Example - Content - 01'
    );
